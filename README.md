...
## Визуализации и Supabase
При успешной настройке Supabase каждая загруженная транзакция сохраняется в БД. На основе всех сохранённых предсказаний автоматически строятся статистические графики, которые иллюстрируют распределение данных и выявленные аномалии. 
